...
class Diffk2Test {
    ...
    fun shouldFindGeneric1() {
        ...
        val result = Diffk2().diffPossible(array, 53)
    ...
    fun shouldFindGeneric2() {
        ...
        val result = Diffk2().diffPossible(array, 97)
    ...
    fun shouldFindGeneri3() {
        ...
        val result = Diffk2().diffPossible(array, 67)
        assertThat(result).isEqualTo(1)
    }
    ...
    fun shouldFindGeneri4() {
        ...
        val result = Diffk2().diffPossible(array, 33)
        assertThat(result).isEqualTo(1)
    }
}