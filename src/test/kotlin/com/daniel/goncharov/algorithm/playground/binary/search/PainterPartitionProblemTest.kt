...
import com.daniel.goncharov.algorithm.playground.interviewbit.search.PainterPartitionProblem
...
class PainterPartitionProblemTest {
    ...
    fun shouldSolveGenericProblem() {
        ...
        val expectedPosition = PainterPartitionProblem()
            .paint(3, 1, board)
