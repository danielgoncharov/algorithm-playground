...
class KnuthMorrisPrattPatternMatchingTest {
    ...
    fun test1() {
        ...
        val result = KnuthMorrisPrattPatternMatching().fullJustify(input, 12)
    ...
    fun test2() {
        ...
        val result = KnuthMorrisPrattPatternMatching().fullJustify(input, 16)
    ...
    fun test4() {
        ...
        val result = KnuthMorrisPrattPatternMatching().fullJustify(input, 20)
        assertThat(result).isEqualTo(arrayListOf(
                "Science  is  what we",
                "understand      well",
